...
PERSONAL_RESULTS = "Look at your own results in comparison"
...
LINEAR_REGRESSION_MODEL = "Is there an effect of onset on reaction time?"
...
button_2e = pn.widgets.Button(name = "Linear Regression Model", height = 75)
...
def violin_comparison(event):
    ...
    mpl_pane = pn.Column(VIOLIN_COMPARISON, pn.pane.Matplotlib(fig, dpi = 480))
    pn.serve(mpl_pane)
...
button_2e.on_click(linear_model)
...
second_panel_general = pn.Column(pn.Row(button_2a, BAR_PLOT), 
                         ...
                         pn.Row(button_2e, LINEAR_REGRESSION_MODEL),
                         css_classes = ["panel-widget-box"],
                         background = "#FFF5EE",
                         sizing_mode = "scale_both")
